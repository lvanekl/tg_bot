...
# TODO (INFO) перенос или удаление несуществующей тренировки ни на что не влияют,
# также как и добавление новой тренировки одновременно с уже существующей
...
# возможно поменять ORM чтобы возвращался id созданного/отредаченного объекта
